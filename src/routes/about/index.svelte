    ...
    >
      <div class="ml-auto lg:col-start-2 lg:max-w-2xl">
        ...
        <p class="mt-4 text-xl leading-6 text-gray-500">
          Product development isn't easy, and neither is content creation. I've
          been a filmmaker, photographer, sales representative, event manager,
          and a startup consultant.<br /><br />Also, this website was built in
          one night.
        </p>
...
<section class="dark:bg-coolGray-800 dark:text-coolGray-100 mx-8">
  <div class="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
    <h2 class="text-3xl font-bold">Technologies I'm familiar with</h2>
    <div class="flex flex-wrap justify-center lg:justify-between">
      <!-- <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
        aria-label="Angular"
        class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-coolGray-400"
      >
        <title>Angular</title>
        <path
...
<section class="max-w-3xl mx-auto mt-4 px-4 sm:px-6 lg:px-8">
<h2 class="text-center text-2xl tracking-tight font-bold sm:text-4xl"> Why you'll love using Factor </h2>
<p class="text-center mt-4 text-lg text-color-500 md:text-xl"> Factor will help you launch websites and applications faster. </p>
</section>