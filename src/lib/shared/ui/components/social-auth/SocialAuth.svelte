<div
  class="fixed p-6 m-auto bg-white rounded-md shadow-md max- mt-16w-sm top-w-full dark:bg-gray-800"
>
  ...
  <form class="mt-6">
    <div>
      <label
        for="username"
        class="block text-sm text-gray-800 dark:text-gray-200">Username</label
      >
      <input
        type="text"
