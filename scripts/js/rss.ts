...
const BASE_URL = URL ? URL : 'https://theo.whatsorcery.com';
...
<rss xmlns:dc="http://purl.org/dc/elements/1.1/"
  ...
  <channel>
    <title><![CDATA[Thoughts on product, content and design]]></title>
    <description><![CDATA[Join Theo as he continues to share what he learns about product design.]]></description>
    <link>${BASE_URL}</link>
